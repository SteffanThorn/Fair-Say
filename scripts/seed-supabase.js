  ...
  maori: [
    {
      ...
      type: 'electorate',
      electorate: 'Waiariki',
      political_spectrum: 'indigenous-rights-left',
      career_before_politics: ['Teacher and musician', 'Tribal advisor and community leader', 'Activist for Māori cultural rights'],
      career_in_politics: ['List MP 2020–2023', 'Elected MP for Waiariki in 2023', 'Co-Leader of Te Pāti Māori since 2020'],
      key_positions: ['Tino rangatiratanga — Māori self-determination', 'Treaty-based governance and constitutional reform', 'Te reo Māori revitalisation', 'Māori electorates preservation', 'Economic justice for Māori communities'],
      accomplishments: ['Led Te Pāti Māori back to hold all 7 Māori electorates in 2023', 'Iconic haka protest on Treaty Principles Bill in Parliament 2024', 'Raised profile of Māori sovereignty internationally'],
      controversies: ['Led haka that disrupted Treaty Principles Bill vote — referred to Privileges Committee', 'Removed from Parliament chamber multiple times for rule breaches', 'Accused by some of grandstanding over substantive policy work'],
    },
    {
      ...
      political_spectrum: 'indigenous-rights-left',
      career_before_politics: ['CEO of Ngāruahine Trust', 'Iwi leader and Treaty negotiator', 'Community health and social services advocate'],
      career_in_politics: ['List MP 2020–2023', 'Elected MP for Te Tai Hauāuru in 2023', 'Co-Leader of Te Pāti Māori since 2020'],
      key_positions: ['Treaty justice and Treaty settlements', 'Māori health equity and whānau ora', 'Environmental protection of Taranaki region', 'Economic development for Māori communities', 'Anti-poverty policy'],
      accomplishments: ['Secured Te Tai Hauāuru electorate seat in 2023', 'Prominent voice for coastal and environmental iwi rights', 'Led Treaty negotiations for Ngāruahine people'],
      controversies: ['Referred to Privileges Committee over haka disruption', 'Some constituents question balance between national profile and electorate work'],
    },
    {
      ...
      political_spectrum: 'indigenous-rights-left',
      career_before_politics: ['Youth activist and student leader', 'Te reo Māori advocate'],
      career_in_politics: ['Elected MP for Hauraki-Waikato in 2023 at age 21 — youngest MP in NZ history'],
      key_positions: ['Te reo Māori in public life', 'Youth issues and intergenerational equity', 'Māori cultural rights', 'Climate action'],
      accomplishments: ['Youngest MP ever elected to NZ Parliament', 'Led viral haka on Treaty Principles Bill — seen globally', 'Strong youth voter mobilisation in 2023 election'],
      controversies: ['Referred to Privileges Committee over haka protest', 'Accused of prioritising symbolism over legislative output as a new MP'],
    },
    {
      name: 'Tākuta Ferris',
      role: 'MP',
      ...
      political_spectrum: 'indigenous-rights-left',
      career_before_politics: ['Lawyer specialising in Treaty and resource management law', 'Community advocate for southern Māori'],
      career_in_politics: ['Elected MP for Te Tai Tonga in 2023'],
      key_positions: ['Treaty-based constitutional change', 'Southern Māori community development', 'Environmental law and resource management', 'Legal rights for Māori land'],
      accomplishments: ['Won Te Tai Tonga for Te Pāti Māori in 2023', 'Brings legal expertise to Treaty rights advocacy'],
      controversies: [],
    },
    {
      ...
      political_spectrum: 'indigenous-rights-left',
      career_before_politics: ['Community health worker and whānau ora navigator', 'Northland health and social services advocate'],
      career_in_politics: ['Elected MP for Te Tai Tokerau in 2023'],
      key_positions: ['Māori health equity', 'Whānau ora and community-led health services', 'Northland regional development', 'Anti-poverty and housing'],
      accomplishments: ['Won Te Tai Tokerau for Te Pāti Māori in 2023', 'Championed community health model in parliament'],
      controversies: [],
    },
    {
      name: 'Hemi Walker',
      ...
      political_spectrum: 'indigenous-rights-left',
      career_before_politics: ['Community leader in Hawke\'s Bay and East Coast regions', 'Māori community development worker'],
      career_in_politics: ['Elected MP for Ikaroa-Rāwhiti in 2023'],
      key_positions: ['East Coast Māori community development', 'Treaty rights', 'Economic development for rural Māori'],
